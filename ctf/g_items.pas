...
{ width }	count_width      : 2;
		...
		info             : nil;
	        tag              : 0;
{ precache }    precaches        : 'ctf/flagcap.wav';
...
{Resistance tech}
	...
	(
	        ...
	        world_model      : 'models/ctf/resistance/tris.md2';
          	...
          	view_model       : nil;
{ icon }        icon             : 'tech1';
{ pickup}	pickup_name      : 'Disruptor Shield';
{ width }	count_width      : 2;
		quantity         : 0;
		ammo             : nil;
		flags            : IT_TECH;
		...
		info             : nil;
	        tag              : 0;
{ precache }    precaches        : 'ctf/tech1.wav';
	...
	(
	        ...
	        world_model      : 'models/ctf/strength/tris.md2';
          	...
          	view_model       : nil;
{ icon }        icon             : 'tech2';
{ pickup}	pickup_name      : 'Power Amplifier';
{ width }	count_width      : 2;
		quantity         : 0;
		ammo             : nil;
		flags            : IT_TECH;
		...
		info             : nil;
	        tag              : 0;
{ precache }    precaches        : 'ctf/tech2.wav ctf/tech2x.wav';
...
{ width }	count_width      : 2;
		...
		info             : nil;
	        tag              : 0;
{ precache }    precaches        : 'ctf/tech3.wav';
